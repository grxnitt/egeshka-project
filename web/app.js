...
const catalogReady = fetch('catalog.json').then(response => { if (!response.ok) throw new Error('catalog'); return response.json(); }).then(async data => { await applyLiveRatings(data); catalog = data; });
catalogReady.catch(() => {});
